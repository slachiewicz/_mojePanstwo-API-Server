<?
	...
	$q = "SELECT ISAP_pozycje_powiazania.typ_id as 'id', ISAP_powiazania_typy.nazwa, ISAP_powiazania_typy.slug, ISAP_powiazania_typy.dropdown, ISAP_pozycje_powiazania.liczba_powiazan as 'count' 
	...
	ORDER BY ISAP_powiazania_typy.ord ASC
	";
	// echo $q; die();
	// return $q;
